      ...
      <div className="pt-32 pb-24">
        <div className="content-max">
          ...
          <LayoutGroup>
            <motion.div
              layout
              className="columns-1 md:columns-2 lg:columns-3 gap-1.5"
            >
        ...
        {currentItem && (
          ...
          >
            ...
            <button
              ...
              className="absolute left-8 top-1/2 -translate-y-1/2 text-foreground hover:text-muted-foreground transition-colors"
            >
              <ChevronLeft className="w-8 h-8" />
            </button>
            <button
              onClick={(e) => { e.stopPropagation(); navigate(1); }}
              className="absolute right-8 top-1/2 -translate-y-1/2 text-foreground hover:text-muted-foreground transition-colors"
            >
